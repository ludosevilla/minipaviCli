	...
	while(true) {
		switch ($step) {
			...
			case 21:
				...
				$vdt.=VDT_CRLF.VDT_TXTWHITE.VDT_BGBLACK.MiniPavi\MiniPaviCli::toG2('Ecrire : numéro .. +').VDT_STARTUNDERLINE.' '.VDT_TXTBLACK.VDT_BGGREEN.' Envoi '.VDT_STOPUNDERLINE.VDT_TXTWHITE.VDT_BGBLACK;
				$vdt.=VDT_CRLF.VDT_TXTWHITE.'Lire vos messages   '.VDT_STARTUNDERLINE.' '.VDT_TXTBLACK.VDT_BGGREEN.' Envoi '.VDT_STOPUNDERLINE.VDT_TXTWHITE.VDT_BGBLACK;
				$vdt.=VDT_CRLF.VDT_TXTWHITE.'Pages'.VDT_STARTUNDERLINE.' '.VDT_TXTBLACK.VDT_BGGREEN.' Suite '.VDT_STOPUNDERLINE.VDT_TXTWHITE.VDT_BGBLACK.' ';				
				$vdt.=VDT_TXTWHITE.VDT_STARTUNDERLINE.VDT_TXTBLACK.VDT_BGGREEN.' Retour '.VDT_STOPUNDERLINE.VDT_TXTWHITE.VDT_BGBLACK.' ';								
				$vdt.=VDT_TXTWHITE.'Sortir'.VDT_STARTUNDERLINE.' '.VDT_TXTBLACK.VDT_BGGREEN.' Sommaire '.VDT_STOPUNDERLINE.VDT_TXTWHITE.VDT_BGBLACK;				
				setStep(22);				
			...
			case 50:
				...
				$vdt.=VDT_CRLF.VDT_TXTWHITE.VDT_BGBLACK.'Changer de ligne'.VDT_STARTUNDERLINE.' '.VDT_TXTBLACK.VDT_BGGREEN.' Suite '.VDT_STOPUNDERLINE.VDT_TXTWHITE.VDT_BGBLACK.' ';			
				$vdt.=VDT_TXTWHITE.VDT_STARTUNDERLINE.VDT_TXTBLACK.VDT_BGGREEN.' Retour '.VDT_STOPUNDERLINE.VDT_TXTWHITE.VDT_BGBLACK.' ';
				$vdt.=VDT_CRLF.VDT_TXTWHITE.'Envoi message'.VDT_STARTUNDERLINE.' '.VDT_TXTBLACK.VDT_BGGREEN.' Envoi '.VDT_STOPUNDERLINE.VDT_TXTWHITE.VDT_BGBLACK;
				$vdt.=VDT_TXTWHITE.' Sortir'.VDT_STARTUNDERLINE.' '.VDT_TXTBLACK.VDT_BGGREEN.' Sommaire '.VDT_STOPUNDERLINE.VDT_TXTWHITE.VDT_BGBLACK;
